...
//        double wheelDiameter = Units.inchesToMeters(4.0);         // TA - I measured less than 4 
        double wheelDiameter = Units.inchesToMeters(3.82);
    ...
    public class driveGearRatios{
        ...
        /** SDS MK4i - 6.75 : 1 */
        public static final double SDSMK4i_L2 = (6.75 / 1.0);  // TODOTA - changed this, our auto distances are off!
  //      public static final double SDSMK4i_L2 = (7.445 / 1.0);
        /** SDS MK4i - 6.12 : 1 */
