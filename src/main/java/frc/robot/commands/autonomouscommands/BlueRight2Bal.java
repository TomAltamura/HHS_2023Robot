...
public class BlueRight2Bal extends SequentialCommandGroup {

    public BlueRight2Bal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
...
//            new WaitCommand(0.75),    // Needed for autonomous only
  ...
  //          new PrepareToPickupFloorAuto(elevator, elbow, clawArms),
            ...
            s_Swerve.PathDrive( ConstPath.blueRightPathD, false),
