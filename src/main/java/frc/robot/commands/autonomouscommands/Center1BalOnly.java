...
public class Center1BalOnly extends SequentialCommandGroup {

    public Center1BalOnly(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
