...
public class NewRight2NoBal extends SequentialCommandGroup {

    public NewRight2NoBal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
                ...
                Commands.sequence(
                    ...
                    Commands.parallel(
                        ...
                        Commands.sequence(
                            ...
                            s_Swerve.PathDrive( ConstPath.newRightPathA, true)
                        )
                    )
                )
            ),
 ...
 //          new PrepareToPickupFloorAuto(elevator, elbow, clawArms),
            ...
            s_Swerve.PathDrive( ConstPath.newRightPathB, false),
            ...
            Commands.parallel(
                ...
                Commands.sequence(
                    ...
                    // drive to cube node
                    s_Swerve.PathDrive( ConstPath.newRightPathC, false)
