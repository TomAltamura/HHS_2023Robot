...
public class zzzNewRight2NoBal extends SequentialCommandGroup {

    public zzzNewRight2NoBal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
            ...
            Commands.parallel(
                ...
                Commands.sequence(
                    ...
                    Commands.parallel(
                        ...
                        s_Swerve.PathDrive( ConstPath.RightPathA1, true)
                    )
                )
            ),
            // spin 180 degrees
            s_Swerve.PathDrive( ConstPath.RightPathA2, false),
            ...
            Commands.parallel(
                ...
                s_Swerve.PathDrive( ConstPath.RightPathA3, false)
            ),
