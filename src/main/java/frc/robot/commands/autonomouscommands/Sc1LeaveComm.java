...
public class Sc1LeaveComm extends SequentialCommandGroup {

    public Sc1LeaveComm(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
