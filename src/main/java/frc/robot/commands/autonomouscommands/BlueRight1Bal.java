...
public class BlueRight1Bal extends SequentialCommandGroup {

    public BlueRight1Bal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
            ...
            Commands.parallel(
                ...
                s_Swerve.PathDrive( ConstPath.blueRight1Bal, true)
            ),
