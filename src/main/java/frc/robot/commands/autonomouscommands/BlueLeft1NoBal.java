...
public class BlueLeft1NoBal extends SequentialCommandGroup {

    public BlueLeft1NoBal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
