...
public class BlueLeft1Bal extends SequentialCommandGroup {

    public BlueLeft1Bal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
            ...
            Commands.parallel(
                ...
                s_Swerve.PathDrive( ConstPath.blueLeft1Bal, true)
            ),
