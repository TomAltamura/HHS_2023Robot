...
public class NewLeft2Bal extends SequentialCommandGroup {

    public NewLeft2Bal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
 ...
 //          new PrepareToPickupFloorAuto(elevator, elbow, clawArms),
            ...
            Commands.parallel(
                ...
                Commands.sequence(
                    ...
                    // drive to cube node
                    s_Swerve.PathDrive( ConstPath.newLeftPathD, false)
