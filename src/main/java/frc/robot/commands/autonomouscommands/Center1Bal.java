...
public class Center1Bal extends SequentialCommandGroup {

    public Center1Bal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
            ...
            Commands.parallel(
                ...
                s_Swerve.PathDrive( ConstPath.Center1NoBalPathA1, true)
            ),

            s_Swerve.PathDrive( ConstPath.Center1NoBalPathA2, false),
            new WaitCommand(1.25),    // Needed for autonomous only - 1.75 was too long, 1.0 was too short

            s_Swerve.PathDrive( ConstPath.Center1BalPath, false),
