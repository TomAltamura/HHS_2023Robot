...
public class zzzNewRight2Bal extends SequentialCommandGroup {

    public zzzNewRight2Bal(SwerveSubsystem s_Swerve, ElevatorSubsystem elevator, ElbowSubsystem elbow,  ClawArmsSubsystem clawArms ) {
        addCommands(
            ...
            Commands.parallel(
                ...
                Commands.sequence(
                    ...
                    // drive to cube node
                    s_Swerve.PathDrive( ConstPath.RightPathC, false)
