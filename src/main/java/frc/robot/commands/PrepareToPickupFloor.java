...
public class PrepareToPickupFloor extends SequentialCommandGroup {
  ...
  public PrepareToPickupFloor(ElevatorSubsystem elevator, ElbowSubsystem elbow, ClawArmsSubsystem clawArms ) {
    addCommands(
      ...
      new ElbowPIDCmd(elbow, 45.0,  ElbowConstants.kMaxVel, ElbowConstants.kMaxAcc, ElbowConstants.kTolerance),      
        ...
        Commands.parallel(
          new ElbowPIDCmd(elbow, ElbowConstants.kRetreiveFromFloorAngle,  ElbowConstants.kMaxVel, ElbowConstants.kMaxAcc, 0),  // No Tolerance - keep PID active to try to keep elbowangle from moving    
