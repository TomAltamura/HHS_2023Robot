...
public class ElbowUpSmall extends CommandBase {
private final ElbowSubsystem elbowSubsystem;
private final SparkMaxPIDController pidController;
private  double setpoint;


  public ElbowUpSmall(ElbowSubsystem elbowSubsystem) {
  ...
  //  System.out.println("ElbowUpSmall started!");
    setpoint = elbowSubsystem.getEncoderDegrees() + ElbowConstants.kSmallMoveDegrees;
    if(setpoint > ElbowConstants.kMaxAngle ) setpoint = ElbowConstants.kMaxAngle;
  }
...
//    System.out.println("ElbowUpSmall ended!");
  }
