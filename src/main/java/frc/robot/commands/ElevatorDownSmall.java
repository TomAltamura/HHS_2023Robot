...
public class ElevatorDownSmall extends CommandBase {
    private final ElevatorSubsystem elevatorSubsystem;
//    private final PIDController pidController;
    private final SparkMaxPIDController pidController;
    private double setpoint;

    public ElevatorDownSmall(ElevatorSubsystem elevatorSubsystem) {
...
//        System.out.println("ElevatorDownSmall started!");
        double startPoint = elevatorSubsystem.getEncoderInches(); 
        setpoint = startPoint - ElevatorConstants.kSmallMoveInches  ;
        if (setpoint < ElevatorConstants.kHomePosition)  setpoint = ElevatorConstants.kHomePosition;
      }
...
//        System.out.println("ElevatorDownSmall ended!");
    }
